    ...
    <div className="p-6 bg-gray-100">
      ...
      <form className="bg-white rounded shadow p-4">
        <div className="mb-4">
          ...
          <input type="text" className="mt-1 block w-full border rounded p-2" placeholder="RentMyRide" />
        </div>
        <div className="mb-4">
          <label className="block text-gray-700">Admin Email</label>
          <input type="email" className="mt-1 block w-full border rounded p-2" placeholder="admin@example.com" />
        </div>
